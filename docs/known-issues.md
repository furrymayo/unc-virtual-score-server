...
| 7 | Realtime pitch count not updating for current pitcher | StatCrew XML `pitches`/`strikes` fields lag behind live count | Use OES or TrackMan as realtime pitch count source | Implementation needed |
